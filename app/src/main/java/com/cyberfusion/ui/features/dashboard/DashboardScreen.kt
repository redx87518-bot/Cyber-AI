...
fun DashboardScreen(navController: NavController) {
    val cards = listOf(
        DashboardCard("Critical Alerts", "12", Icons.Default.Security),
        DashboardCard("Investigations", "8", Icons.Default.Security),
        DashboardCard("Active Incidents", "3", Icons.Default.Security),
        DashboardCard("Lab Progress", "68%", Icons.Default.Security)
    )
